...
const angielskie = ['aunt', 'brother', 'brother-in-law', 'cousin', 'dad', 'daughter', 'daughter-in-law', 'ex-husband', 'ex-wife', 'father', 'father-in-law', 'grandchildren', 'granddaughter', 'grandfather', 'grandmother', 'grandpa', 'grandparents', 'grandson', 'granny', 'great-grandchildren', 'great-granddaughter', 'great-grandfather', 'great-grandmother', 'great-grandparents', 'great-grandson', 'half-brother', 'half-sister', 'husband', 'mother', 'mother-in-law', 'mum', 'nephew', 'niece', 'only child', 'parents', 'parents-in-law', 'relative', 'sister', 'sister-in-law', 'single father', 'single mother', 'single parent', 'son', 'son-in-law', 'twin brother', 'twin sister', 'twins', 'uncle', 'wife', 'be widowed', 'divorce', 'engaged', 'get engaged', 'become engaged', 'engagement', 'get a divorce/divorced', 'get married to sb', 'honeymoon', 'marriage', 'married couple', 'marry sb', 'propose marriage', 'propose to sb', 'remarry', 'separation', 'stay single', 'wedding', 'be a strict parent', 'be expecting a child', 'be pregnant', 'care for sb', 'get pregnant', 'give birth to a child', 'grow out of sth', 'grow up', 'have a baby', 'look after sb', 'look alike', 'take care of sb', 'acquaintance', 'boyfriend', 'circle of friends', 'colleague', 'date', 'fascination', 'friend', 'best friend', 'close friend', 'family friend', 'girlfriend', 'love at first sight', 'mate', 'mutual', 'schoolmate', 'soulmate', 'ask sb out', 'be fond of sb', 'be in love with sb', 'be ready for a serious relationship', 'get along well with sb', 'get on well with sb', 'go out with sb', 'get together with sb', 'have sth/a lot in common with sb', 'look up to sb', 'love sb', 'make new friends', 'rely on sb', 'share interests', 'split up', 'start a relationship with sb', 'stay in touch with sb', 'babysit', 'cook a meal', 'daily routine', 'eat out', 'get dressed', 'get ready for bed/school', 'get the children to school', 'get up', 'go to bed early/late', 'go to school', 'go to work', 'have a coffee', 'have a meal', 'have breakfast', 'have dinner', 'have lunch', 'have supper', 'have tea', 'have a bath', 'have a nap', 'have a rest', 'have a shower', 'lie down', 'pick up the children from school', 'prepare a meal', 'take it in turns to do sth', 'take the children to school', 'take the dog for a walk', 'undress', 'wake up', 'ball', 'entertainment', 'free time', 'leisure activities', 'party', 'dance party', 'fancy-dress party', 'house party', 'weekend plans', 'do a Spanish conversation course', 'do creative writing', 'enjoy yourself', 'go bowling', 'go cycling', 'go dancing', 'go for a walk', 'go jogging', 'go kayaking', 'go online', 'go out', 'go out for a meal', 'go sightseeing', 'go to a concert', 'go to a disco', 'go to a party', 'go to the cinema', 'go to the gym', 'hang out with friends', 'have a good time', 'have fun', 'listen to music', 'listen to the radio', 'look forward to sth', 'meet friends', 'play badminton', 'play cards', 'play chess', 'play video games', 'play sports', 'play the guitar', 'play the ukulele', 'read aloud to sb', 'spend time outdoors', 'spend time together', 'spend time with friends and family', 'stay at home', 'watch a film', 'watch TV', 'Boxing Day', 'Christmas', 'Christmas carol', 'Christmas Day', 'Christmas decorations', 'Christmas Eve', 'Christmas fair', 'Christmas tree', 'break the wafer', 'decorate the Christmas tree', 'first star in the sky', 'Santa Claus', 'wrap a present', 'unwrap a present', "make New Year's resolutions", "New Year's Day", "New Year's Eve", 'set off fireworks', 'wait till midnight', 'Easter', 'Easter basket', 'Easter bunny', 'Easter eggs', 'Easter Sunday', 'Easter Monday', 'go on an egg hunt', 'paint eggs', 'Wet Monday', 'bank holiday', "Children's Day", 'Chinese New Year', "Father's Day", 'Halloween', 'Independence Day', 'Labour Day', "Mother's Day", 'public holiday', "Valentine's Day", "Women's Day", 'anniversary', 'birthday', 'birthday cake', 'birthday present', 'birthday party', 'celebration', 'ceremony', 'festival', 'funeral', 'wedding', 'wedding ceremony', 'wedding reception', 'blow out candles', 'carve pumpkins', "celebrate sb's birthday", 'dress up as sb/sth', 'express good wishes', 'follow the custom', 'give a card', 'go trick-or-treating', 'have a celebration', 'take part in a parade', 'active', 'avoid stress', 'balanced diet', 'busy', 'busy schedule', 'do regular exercise', 'habit', 'eating habits', 'keep fit', 'lifestyle change', 'out of shape', 'reduce stress', 'stressful', 'stressed', 'tiring', 'argue', 'argument', "break sb's heart", 'break up with sb', 'controlling', 'cross personal boundaries', 'disagree', 'disagreement', 'end a relationship with sb', 'fall out with sb', 'family values', 'generation gap', 'have a bad relationship with sb', 'have a row', 'have an argument', 'hurt sb', 'jealous', 'let sb down', 'make it up to sb after an argument', 'push the limits', 'quarrel with sb', 'rebel', 'rebellion', 'run away from home', 'set boundaries', 'split-up', 'talk sth through', 'tell sb off'];
const polskie = ['ciocia', 'brat', 'szwagier', 'kuzyn, kuzynka', 'tata, tatuś', 'córka', 'synowa', 'były mąż', 'była żona', 'ojciec', 'teść', 'wnuki', 'wnuczka', 'dziadek [gradnf]', 'babcia [grand]', 'dziadek [grandp]', 'dziadkowie', 'wnuk', 'babcia [gran]', 'prawnuki', 'prawnuczka', 'pradziadek', 'prababcia', 'pradziadkowie', 'prawnuk', 'brat przyrodni', 'siostra przyrodnia', 'mąż', 'matka', 'teściowa', 'mama, mamusia', 'siostrzeniec, bratanek', 'siostrzenica, bratanica', 'jedynak, jedynaczka', 'rodzice', 'teściowie [par]', 'krewny', 'siostra', 'szwagierka, bratowa', 'ojciec samotnie wychowujący', 'matka samotnie wychowująca dziecko', 'rodzic samotnie wychowujący dziecko', 'syn', 'zięć', 'brat bliźniak', 'siostra bliźniaczka', 'bliźniaki', 'wujek, stryjek', 'żona', 'być wdową/wdowcem', 'rozwieść się; rozwód', 'zaręczony, zaręczona', 'zaręczyć się [g]', 'zaręczyć się [b]', 'zaręczyny', 'rozwieść się', 'poślubić kogoś [g]', 'miesiąc miodowy', 'małżeństwo (związek)', 'małżeństwo (para małżeńska)', 'poślubić kogoś [m]', 'oświadczyć się', 'oświadczyć się komuś', 'ponownie wyjść za mąż, ożenić się', 'separacja', 'pozostać w stanie wolnym', 'ślub, wesele', 'być surowym rodzicem', 'spodziewać się dziecka', 'być w ciąży', 'troszczyć się o kogoś', 'zajść w ciążę', 'urodzić dziecko [g]', 'wyrosnąć z czegoś', 'dorastać', 'urodzić dziecko [h]', 'opiekować się kimś [l]', 'wyglądać podobnie', 'opiekować się kimś [t]', 'znajomy, znajoma; znajomość', 'chłopak (sympatia)', 'grono przyjaciół', 'kolega, koleżanka z pracy', 'randka', 'fascynacja, zauroczenie', 'przyjaciel, przyjaciółka', 'najlepszy przyjaciel, najlepsza przyjaciółka', 'bliski przyjaciel, bliska przyjaciółka', 'przyjaciel/przyjaciółka rodziny', 'dziewczyna (sympatia)', 'miłość od pierwszego wejrzenia', 'kumpel, kumpelka', 'wzajemny', 'kolega, koleżanka ze szkoły', 'bratnia dusza', 'zaprosić kogoś na randkę', 'czuć do kogoś sympatię', 'być zakochanym (w kimś)', 'być gotowym na poważny związek', 'być z kimś w dobrych stosunkach', 'mieć z kimś dobre relacje', 'chodzić z kimś, umawiaćsię z kimś na randki', 'spotykać się z kimś', 'mieć z kimś coś/wiele wspólnego', 'podziwiać kogoś', 'kochać kogoś', 'zawierać nowe przyjaźnie', 'polegać na kimś', 'mieć podobne zainteresowania', 'rozstać się, rozejść się', 'wejść z kimś w związek', 'utrzymywać kontakt z kimś', 'opiekować się dzieckiem (kogoś innego)', 'ugotować posiłek', 'ustalony porządek dnia', 'jeść poza domem', 'ubierać się', 'szykować się (do snu/szkoły)', 'zaprowadzić/zawieźć dzieci do szkoły [g]', 'wstawać', 'kłaść się spać (wcześnie/późno)', 'iść do szkoły', 'iść do pracy', 'wypić kawę', 'zjeść posiłek', 'jeść śniadanie', 'jeść obiad', 'jeść lunch', 'jeść kolację', 'jeść podwieczorek; pić herbatę', 'brać kąpiel', 'zdrzemnąć się', 'odpoczywać', 'brać prysznic', 'położyć się', 'odebrać dzieci ze szkoły', 'przygotować posiłek', 'wykonywać coś na zmianę', 'zaprowadzić/zawieźć dzieci do szkoły [t]', 'wyprowadzić psa na spacer', 'rozbierać się', 'budzić się', 'bal', 'rozrywka', 'czas wolny', 'zajęcia w czasie wolnym', 'impreza', 'potańcówka', 'bal kostiumowy', 'impreza w domu domówka', 'plany na weekend', 'uczęszczać na kurs konwersacyjny języka hiszpańskiego', 'uczyć się kreatywnego pisania', 'dobrze się bawić', 'iść na kręgle', 'jeździć na rowerze', 'iść potańczyć', 'iść na spacer', 'iśc pobiegać', 'pływać kajakiem', 'spędzać czas w internecie', 'wychodzić z domy', 'iśc do restauracji', 'zwiedzać', 'iśc na koncert', 'iść na dyskotekę', 'iść na przyjęcie', 'iśc do kina', 'iśc na siłownię', 'spędzać czas z przyjaciółmi', 'dobrze się bawić [... time]', 'dobrze się bawić [... fun]', 'słuchać muzyki', 'słuchać radia', 'czekać na coś z niecierpliwością', 'spotykać się z przyjaciółmi', 'grać w badmintona', 'grać w karty', 'grać w szachy', 'grać w gry komputerowe', 'uprawiać sport', 'grać na gitarze', 'grać na ukulele', 'czytać komuś na głos', 'spędzać czas na świeżym powietrzu', 'spędzać cczas razem', 'spędzać czas z rodziną i przyjaciółmi', 'zostawać w domu', 'oglądać film', 'oglądać telewizję', 'drugi dzień świąt Bożego Narodzenia', 'Boże Narodzenie', 'kolęda', 'pierwszy dzień świąt', 'ozdoby', 'Wigilia', 'targ bożonarodzeniowy', 'choinka', 'łamac się opłatkiem', 'ubierać choinkę', 'pierwsza gwiazda na niebie', 'Święty Mikołaj', 'zapakować prezent', 'odpakować prezent', 'robić postanowienia noworoczne', 'Nowy Rok', 'sylwester', 'odpalać fajerwerki', 'wyczekiwać północy', 'Wielkanoc', 'święconka', 'zajączek wielkanocny', 'pisanka', 'niedziela wielkanocna', 'poniedziałek wielkanocny', 'szukać jajek od zajączka', 'malować jajka', 'lany poniedziałek', 'dzień ustawowo wolny od pracy [b]', 'Dzień Dziecka', 'Chiński Nowy Rok', 'Dzień Ojca', 'Halloween', 'Święto Niepodległości', 'Święto Pracy', 'Dzień Matki', 'dzień ustawowo wolny od pracy [p]', 'walentynki', 'Dzień Kobiet', 'rocznica', 'urodziny', 'tort urodzinowy', 'prezent urodzinowy', 'przyjęcie urodzinowe', 'uroczystość [ ...brat...]', 'uroczystość [cer...]', 'festyn', 'pogrzeb', 'ślub', 'ceremonia zaślubin', 'przyjęcie weselne', 'zdmuchiwać świeczki', 'wydrążać dynie', 'obchodzić czyjeś urodziny', 'przebrać się za kogoś/coś', 'składac życzenia', 'przestrzegać zwyczaju', 'podarować kartkę okolicznościową', 'chodzić z cukierkiem albo psikusem', 'świętować', 'uczestniczyć w paradzie', 'aktywny', 'unikać stresu', 'zbilansowana dieta', 'aktywny/pracowity', 'wypełniony harmonogram', 'ćwiczyć regularnie', 'nawyk', 'nawyki żywieniowe', 'utrzymywać formę', 'zmiana stylu życia', 'nie w formie', 'oraniczyć stres', 'stresujący', 'zestresownay', 'męczący', 'kłósić się', 'kłótnia', 'złamać komuś serce', 'zerwać z kimś', 'kontrolujący', 'przekraczać granice osobistre', 'nie zgadzać się', 'różnica zdań', 'zakończyć z kimś związek', 'pokłócić się z kimś', 'wartości rodzinne', 'konflikt pokoleń', 'być z kimś w złych stosunkach', 'pokłócić się [... row]', 'pokłócić się [... arg]', 'zranić kogoś', 'zazdrosny', 'zawieść kogoś', 'zrekompensować komuś kłótnię', 'przesuwać granice', 'pokłóciś się z kimś', 'buntować się', 'bunt', 'uciekać z domu', 'ustalać granice', 'rozstanie', 'omówić coś', 'ganić kogoś'];
